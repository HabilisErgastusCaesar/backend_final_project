...
-- CreateTable
CREATE TABLE `AmenityOnProperty` (
    `propertyId` VARCHAR(191) NOT NULL,
    `amenityId` VARCHAR(191) NOT NULL,

    INDEX `AmenityOnProperty_propertyId_idx`(`propertyId`),
    INDEX `AmenityOnProperty_amenityId_idx`(`amenityId`),
    UNIQUE INDEX `AmenityOnProperty_propertyId_amenityId_key`(`propertyId`, `amenityId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
